...
#ifndef MSPTI_CONVERT_TSFW_CONVERT_H
#define MSPTI_CONVERT_TSFW_CONVERT_H
...
namespace Mspti {
namespace Convert {
class TsfwConvert : public BasicConvert<TsfwConvert, StepTraceBasic> {
public:
    static TsfwConvert& GetInstance();
    ~TsfwConvert() = default;
...
#endif // MSPTI_CONVERT_TSFW_CONVERT_H